...
INSERT INTO Customers(First,Last,City,ZIP,State,Street) VALUES (2,'Bren','Giamuzzo','Tucson',85720,'Arizona','84615 Rusk Trail');
INSERT INTO Customers(First,Last,City,ZIP,State,Street) VALUES (3,'Randolf','Tremblot','Saint Louis',63116,'Missouri','8418 Dryden Point');

-- Brands
INSERT INTO Brands(Name,Email,City,ZIP,State,Street) VALUES (1,'Obediah O''Moylane','oomoylane0@go.com','Toledo',43656,'Ohio','9 Melby Court');
INSERT INTO Brands(Name,Email,City,ZIP,State,Street) VALUES (2,'Hermie Manns','hmanns1@sakura.ne.jp','Inglewood',90305,'California','2081 Shopko Parkway');
INSERT INTO Brands(Name,Email,City,ZIP,State,Street) VALUES (3,'Gabby Oosthout de Vree','goosthout2@ucsd.edu','Orlando',32835,'Florida','6 Loeprich Drive');
...
-- Products
INSERT INTO Products(Name,Description,Price,BrandID,Category_Title) VALUES ('Cheese - Le Cheve Noir','circuit',1,47,1,'Fuscia');
INSERT INTO Products(Name,Description,Price,BrandID,Category_Title) VALUES ('Steam Pan Full Lid','benchmark',2,47,2,'Teal');
INSERT INTO Products(Name,Description,Price,BrandID,Category_Title) VALUES ('Flower - Leather Leaf Fern','Organic',3,60,3,'Aquamarine');
...
-- Carriers
INSERT INTO Carriers(Phone,Email) VALUES (1,'801-887-3263','echasmer0@si.edu');
INSERT INTO Carriers(Phone,Email) VALUES (2,'415-547-0169','hinnes1@noaa.gov');
INSERT INTO Carriers(Phone,Email) VALUES (3,'216-184-9563','glivzey2@google.com');
...
-- Orders
INSERT INTO Orders(Price,CustomerID,isReturn) VALUES (1,34,1,0);
INSERT INTO Orders(Price,CustomerID,isReturn) VALUES (2,90,2,1);
INSERT INTO Orders(Price,CustomerID,isReturn) VALUES (3,68,3,1);
...
-- Wish_lists
INSERT INTO Wish_lists(Name,CustomerID) VALUES (1,'Jaquith',1);
INSERT INTO Wish_lists(Name,CustomerID) VALUES (2,'Mufi',2);
INSERT INTO Wish_lists(Name,CustomerID) VALUES (3,'Alexina',3);
